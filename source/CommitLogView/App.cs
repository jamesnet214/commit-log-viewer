...
namespace CommitLogView
{
    public class App : Application
    {
        ...
        {
            base.OnStartup(e);
            Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("/CommitLogView;component/Themes/Units/WindowScrollViewer.xaml", UriKind.RelativeOrAbsolute) });
